...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarToggler = function () {
        ...
        $('body').on("click",'.top-menu .dropdown-quick-sidebar-toggler a, .page-quick-sidebar-toggler',function (e) {
    ...
    var handleQuickSidebarChat = function () {
        ...
        $("body").on('click','.page-quick-sidebar-chat-users .media-list > .media',wrapper,function () {
